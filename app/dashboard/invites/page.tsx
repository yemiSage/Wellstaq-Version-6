...
export default function PendingInvitesPage() {
  ...
  return <div className="mx-auto flex max-w-7xl flex-col gap-5 pb-12">
    <div><h1 className="page-title">Pending Invites</h1><p className="page-description">{branchId ? `Pending invitations for ${branchNames.get(branchId) ?? "this branch"}.` : "All pending invitations across the organization."}</p></div>
