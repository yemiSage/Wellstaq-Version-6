        ...
        <div className="flex-1 bg-white rounded-[8px] border border-grey-4 p-5">
            ...
            <>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-12 h-6 bg-[#EA6A05] rounded-full relative cursor-pointer">
          ...
          {activeTab === "billing" && (
            <>
              ...
              <div className="p-6 rounded-xl bg-[#EA6A05]/5 border border-[#EA6A05]/20 mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <div className="text-xs font-bold text-[#EA6A05] uppercase tracking-wider">Current Plan</div>
                    <div className="text-2xl font-bold text-grey-1">Professional Plan</div>
                  </div>
                  <div className="px-3 py-1 rounded-full bg-[#EA6A05] text-white text-[10px] font-bold">ACTIVE</div>
                </div>
                <div className="text-sm text-grey-2 mb-6">Your next billing date is April 23, 2026 for $49.00.</div>
                <Button className="bg-[#EA6A05] hover:bg-[#EA6A05]/90">Upgrade Plan</Button>
              </div>
