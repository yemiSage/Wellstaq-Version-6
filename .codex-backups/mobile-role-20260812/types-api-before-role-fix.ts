...
export interface RoleItem { id: string; name: string; description: string | null; branchId?: string | null; isSystem?: boolean; isDefault?: boolean; userCount?: number; permissions?: string[]; }
