...
export const api = {
  ...
  roles: {
    ...
    copy: (orgId: string, roleId: string, body: { name: string; branchId: string }) => fromApiOrMock<RoleItem>(
  ...
  permissions: {
    listCatalogue: () => fromApiOrMock<PermissionCatalogueResponse>("/permissions", { items: [], total: 0 }),
